...
import com.ry.fu.net.common.seq.annotations.LockAction;
 ...
 * @description LockAction 切面处理及加载
 */
@Aspect
@Configuration
...
public class DistributedLockAspectConfiguration {
    ...
    @Pointcut("@annotation(com.ry.fu.net.common.seq.annotations.LockAction)")
