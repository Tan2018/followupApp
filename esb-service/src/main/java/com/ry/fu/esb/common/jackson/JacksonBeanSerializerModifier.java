...
import static com.ry.fu.esb.common.jackson.SerializerFeature.*;
...
public class JacksonBeanSerializerModifier extends BeanSerializerModifier {
    ...
    public JacksonBeanSerializerModifier(com.ry.fu.esb.common.jackson.SerializerFeature... features) {
        int config = 0;
        for (com.ry.fu.esb.common.jackson.SerializerFeature feature : features) {
            config |= feature.mask;
        }
