...
public class InspectionReportResponseRecodeResultGerm {
    /**
     * 细菌英文名称
     */
    ...
    private List<InspectionReportResponseRecodeResultGermAnitbiotis> inspectionReportResponseResultGermAnitbiotis;
}
