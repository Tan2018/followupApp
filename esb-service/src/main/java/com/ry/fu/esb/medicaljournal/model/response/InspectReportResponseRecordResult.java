...
public class InspectReportResponseRecordResult implements Serializable{
    private static final long serialVersionUID = 8925757314817931839L;
    /**
     * 检验编码
     */
    ...
    private List<InspectReportResponseRecordResultGerm> inspectionReportResponseResultGerm;
