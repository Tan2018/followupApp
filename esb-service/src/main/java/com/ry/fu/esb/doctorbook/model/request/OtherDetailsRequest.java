...
@Data
public class OtherDetailsRequest implements Serializable{
    /**
     *
     */
    ...
    /**
     * 检查类型，默认全部: 4超声 5内镜 6核医学 7心电图 8病理资料 9ALO 10ALO-随医拍（多个类型，逗号分隔）
     */
    @XmlElement(name = "FUNC_TYPE",required = false)
    private String funcType = "4,5,6,7,8,9,10";
    /**
     * 起始日期（不填默认当天）
     */
